"""
Simplified academic domain schemas.
Temporary version to avoid circular imports.
"""
...
from app.schemas.hr import Department


# Simple Schedule schema to avoid circular imports
from datetime import time

class ScheduleInfo(BaseSchema):
    """Schedule information for StudentGroup responses."""
