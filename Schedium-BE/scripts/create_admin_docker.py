#!/usr/bin/env python
"""
Create initial admin user for Docker deployment.
Non-interactive version that uses environment variables or defaults.
"""
...
def create_admin_user():
    """Create initial admin user using environment variables or defaults."""
    print("=" * 60)
    print("Create Admin User (Docker)")
    print("=" * 60)
    ...
    try:
        ...
        last_name = os.getenv("ADMIN_LAST_NAME", "System")
        email = os.getenv("ADMIN_EMAIL", "admin@schedium.local")
        document_number = os.getenv("ADMIN_DOCUMENT", "00000000")
