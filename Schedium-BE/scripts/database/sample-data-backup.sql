...
-- Cursos básicos por programa
INSERT IGNORE INTO course (name, hours, credits, program_id, active, created_at, updated_at) VALUES
-- Sistemas
('Fundamentos de Programación', 80, 4, 1, TRUE, NOW(), NOW()),
('Base de Datos I', 60, 3, 1, TRUE, NOW(), NOW()),
('Análisis y Diseño de Sistemas', 80, 4, 1, TRUE, NOW(), NOW()),
-- Redes
('Fundamentos de Redes', 80, 4, 2, TRUE, NOW(), NOW()),
('Configuración de Routers', 60, 3, 2, TRUE, NOW(), NOW()),
('Seguridad en Redes', 60, 3, 2, TRUE, NOW(), NOW()),
-- Administración
('Principios de Administración', 60, 3, 3, TRUE, NOW(), NOW()),
('Contabilidad General', 80, 4, 3, TRUE, NOW(), NOW()),
('Mercadeo y Ventas', 60, 3, 3, TRUE, NOW(), NOW()),
-- Enfermería
('Fundamentos de Enfermería', 100, 5, 4, TRUE, NOW(), NOW()),
('Anatomía y Fisiología', 80, 4, 4, TRUE, NOW(), NOW()),
('Primeros Auxilios', 40, 2, 4, TRUE, NOW(), NOW()),
-- Atención Prehospitalaria
('Soporte Vital Básico', 60, 3, 5, TRUE, NOW(), NOW()),
('Trauma y Emergencias', 80, 4, 5, TRUE, NOW(), NOW()),
('Transporte Sanitario', 40, 2, 5, TRUE, NOW(), NOW());
...
SELECT '✅ Datos de ejemplo insertados correctamente!' as resultado,
       ...
       (SELECT COUNT(*) FROM course) as total_cursos;